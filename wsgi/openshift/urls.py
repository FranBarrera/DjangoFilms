...
urlpatterns = patterns('',
    ...
    url(r'^logout/$', 'openshift.DjangoFilms.views.logout'),
...
#    url(r'^peliculas/(?P<api>[0-9]{0,9})/vista$', 'openshift.DjangoFilms.views.insert_media'),
    ...
    url(r'^peliculas/user$', 'openshift.DjangoFilms.views.user_peliculas'),
    url(r'^busqueda/$', 'openshift.DjangoFilms.views.searcher'),
